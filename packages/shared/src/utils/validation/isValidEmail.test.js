...
describe('"isValidEmail"', () => {
  ...
  test('should return true when a valid email is supplied', () => {
  ...
  test('should return false when no email is supplied', () => {
    expect(isValidEmail()).toBe(false);
  });

  test('should return false when a invalid email is supplied', () => {
